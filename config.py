    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Net(fontsize=10, interface="wlp2s0", background=color_wlan, foreground="#181818"),
...
autostart = [
    "picom --no-vsync &",
    "nm-applet &",
    "feh --bg-fill /home/codintdev/Escritorio/codintdev/wallpapers/watch_dogs_1.jpg",
