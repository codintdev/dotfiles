...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    # ---------- Apps Config ----------
    ([mod, "shift"], "f", lazy.spawn("firejail firefox")),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Net(interface='enp0s3', fontsize=10, background=color_wlan, foreground="#181818"),
...
autostart = [
    ...
    #"qtile config border_width 0",
   # "nm-applet &",
    "feh --bg-fill /home/codintdev/Desktop/codintdev/wallpapers/pixel_art.png",
